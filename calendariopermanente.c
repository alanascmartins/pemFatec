...
int procurarLinha(int L, int C, int mat[L][C], int procurado){ // Método para retornar a linha em que procurado aparece na matriz (A1 ou A2)
...
void diaSemana(int dia){ // Método para mostrar dia da Semana a partir do valor
...
}else if(ano > 2000 && ano <=2092){  // Escolha da matriz A2, pois a 1ª dezena do ano é 20 e o resto (2ª dezena) do ano está entre 01 e 92
